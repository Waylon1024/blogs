package top.waylon.util.comment;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.beans.factory.annotation.Value;
import org.springframework.context.annotation.DependsOn;
import org.springframework.stereotype.Component;
import top.waylon.config.properties.BlogProperties;
import top.waylon.constant.PageConstants;
import top.waylon.constant.RedisKeyConstants;
import top.waylon.entity.User;
import top.waylon.model.dto.Comment;
import top.waylon.model.vo.FriendInfo;
import top.waylon.service.AboutService;
import top.waylon.service.BlogService;
import top.waylon.service.FriendService;
import top.waylon.service.RedisService;
import top.waylon.service.UserService;
import top.waylon.util.HashUtils;
import top.waylon.util.IpAddressUtils;
import top.waylon.util.MailUtils;
import top.waylon.util.QQInfoUtils;
import top.waylon.util.StringUtils;
import top.waylon.util.comment.channel.ChannelFactory;
import top.waylon.util.comment.channel.CommentNotifyChannel;
import top.waylon.enums.CommentOpenStateEnum;
import top.waylon.enums.CommentPageEnum;
...
public class CommentUtils {
	 ...
	 */
	public void judgeSendNotify(Comment comment, boolean isVisitorComment, top.waylon.entity.Comment parentComment) {
	 ...
	 * @param comment       当前收到的评论
	 */
	private void sendMailToParentComment(top.waylon.entity.Comment parentComment, Comment comment) {
