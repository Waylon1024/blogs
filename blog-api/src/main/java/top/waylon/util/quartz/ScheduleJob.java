package top.waylon.util.quartz;

import lombok.extern.slf4j.Slf4j;
import org.quartz.JobExecutionContext;
import org.springframework.scheduling.quartz.QuartzJobBean;
import top.waylon.entity.ScheduleJobLog;
import top.waylon.service.ScheduleJobService;
import top.waylon.util.common.SpringContextUtils;
...
public class ScheduleJob extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext context) {
		top.waylon.entity.ScheduleJob scheduleJob = (top.waylon.entity.ScheduleJob) context.getMergedJobDataMap().get(top.waylon.entity.ScheduleJob.JOB_PARAM_KEY);
		//获取spring bean
