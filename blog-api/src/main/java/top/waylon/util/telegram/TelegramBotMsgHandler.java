package top.waylon.util.telegram;
...
import top.waylon.config.properties.TelegramProperties;
import top.waylon.entity.Comment;
...
public class TelegramBotMsgHandler {
	...
	private String replyComment(String msgContent) {
		...
		if (splitIndex2 != -1 && msgContent.length() > splitIndex2 + 1) {
			...
			top.waylon.model.dto.Comment comment = new top.waylon.model.dto.Comment();
