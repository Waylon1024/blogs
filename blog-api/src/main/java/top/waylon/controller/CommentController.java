...
import top.waylon.annotation.AccessLimit;
import top.waylon.constant.JwtConstants;
import top.waylon.entity.User;
import top.waylon.model.dto.Comment;
import top.waylon.model.vo.PageComment;
...
public class CommentController {
	...
	public Result postComment(@RequestBody Comment comment,
		...
		//父评论
		top.waylon.entity.Comment parentComment = null;
